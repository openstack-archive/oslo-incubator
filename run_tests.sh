...
# Use `./run_tests.sh -h` `./run_tests.sh --help` to get usage message
#
...
# this option include {PROJECT_NAME}/* directory to coverage report
# if OMIT_OSLO_FROM_COVERAGE equals to one
export PROJECT_NAME="oslo-incubator"

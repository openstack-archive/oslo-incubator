...
class ConfigFileOptsTestCase(BaseTestCase):
    ...
    def test_multi_conf_file_str_value_use_deprecated(self):
        """Two config files, new option used in first file. New option wins"""
        self.conf.register_opt(StrOpt('newfoo', deprecated_name='oldfoo'))
        ...
        self.assertEquals(self.conf.newfoo, 'new')

...
class RpcKombuTestCase(common.BaseRpcAMQPTestCase):
    ...
    def test_queue_not_declared_ha_if_ha_off(self):
        FLAGS.rabbit_ha_queues = False

        import kombu.entity
        def my_declare(myself):
            self.assertEqual(None, (myself.queue_arguments or {}).get('x-ha-policy'))
    ...
    def test_queue_declared_ha_if_ha_on(self):
        FLAGS.rabbit_ha_queues = True

        import kombu.entity
        def my_declare(myself):
            self.assertEqual('all', (myself.queue_arguments or {}).get('x-ha-policy'))

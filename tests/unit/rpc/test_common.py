...
class RpcCommonTestCase(test_utils.BaseTestCase):
    ...
    def _test_msg_signing(self, msg, src, dst, enforced=True):
        cfg.CONF.secure_messages.enforced = enforced
        ...
        try:
            ...
            cfg.CONF.secure_messages.enforced = False
    ...
    def test_msg_signing_ok(self):
        ...
        key = [src[0] + ':DwsLDwsLDwsLDwsLDwsLDw==',
               dst[0] + ':CwsLCwsLCwsLCwsLCwsLCw==']
        cfg.CONF.secure_messages.secret_key = key
        source = '%s.%s' % src
        target = '%s.%s' % dst
    ...
    def test_msg_signing_opt_nofail_no_dest(self):
        ...
        ret = self._test_msg_signing(msg, src, ('bad', 'host'), enforced=False)
    ...
    def test_msg_signing_fail_dstkey(self):
        ...
        key = [src[0] + ':BadLDwsLDwsLDwsLDwsLDw==',

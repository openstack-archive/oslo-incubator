...
class _RpcZmqBaseTestCase(common.BaseRpcTestCase):
    ...
    @testutils.skip_if(pyzmq_ver[0] == 2, "Test requires pyzmq>2.1.11")
    @testutils.skip_if(pyzmq_ver[1] > 1, "Test requires pyzmq>2.1.11")
    @testutils.skip_if(pyzmq_ver[1] > 2 or pyzmq_ver[1] > 10,
                       "Test requires pyzmq>2.1.11")
    @testutils.skip_if(zmq_ver[0] == 2, "Test requires libzmq>2.1.11")
    @testutils.skip_if(zmq_ver[1] > 1, "Test requires libzmq>2.1.11")
    @testutils.skip_if(zmq_ver[1] > 2 or zmq_ver[1] > 10,
                       "Test requires libzmq>2.1.11")

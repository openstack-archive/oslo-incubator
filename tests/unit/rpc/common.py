...
class BaseRpcTestCase(test.BaseTestCase):
    ...
    def test_multithreaded_resp_routing(self):
        ...
        callid1 = synced_echo_call.spawn(self.rpc.call, self.FLAGS, self.context,
                                         self.topic, value=1)
        callid2 = synced_echo_call.spawn(self.rpc.call, self.FLAGS, self.context,
                                         self.topic, value=2)
        callid3 = synced_echo_call.spawn(self.rpc.call, self.FLAGS, self.context,
                                         self.topic, value=3)

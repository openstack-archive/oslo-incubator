...
class CommonLoggerTestsMixIn(object):
    ...
    def test_will_be_debug_if_debug_openstack_flag_set(self):
        self.config(debug_openstack=True)
        log.setup("test_is_debug_openstack")
    ...
    def test_will_be_debug_if_debug_and_debug_openstack_flag_set(self):
        self.config(debug=True, debug_openstack=True)
        log.setup("test_is_debug_and_debug_openstack")
        root_logger = logging.getLogger()
...
class LogConfigOptsTestCase(test.BaseTestCase):
    ...
    def test_print_help(self):
        ...
        self.assertTrue('debug-openstack' in f.getvalue())
    ...
    def test_debug_verbose(self):
        self.CONF(['--debug', '--debug-openstack', '--verbose'])

        self.assertEqual(self.CONF.debug, True)
        self.assertEqual(self.CONF.debug_openstack, True)

...
from oslo.i18n import fixture as fixture_i18n
...
class ContextFormatterTestCase(LogTestBase):
    def setUp(self):
        ...
        self.fixture_i18n = self.useFixture(fixture_i18n.Translation())
    ...
    def test_message_logging_3rd_party_log_records(self):
        ...
        try:
            sa_log = logging.getLogger('sqlalchemy.engine')
            sa_log.setLevel(logging.INFO)
            message = self.fixture_i18n.lazy('test ' + six.unichr(128))
            sa_log.info(message)
    ...
    def test_unicode_conversion_in_adapter(self):
        ...
        ex = Exception(self.fixture_i18n.lazy('test' + six.unichr(128)))

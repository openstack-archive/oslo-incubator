...
class SysLogHandlersTestCase(test.BaseTestCase):
    ...
    def test_rfc_format(self):
        ...
        self.assertEqual(self.rfclogger.format(logrecord), expected.getMessage())
    ...
    def test_standard_format(self):
        ...
        logrecord = logging.LogRecord('name', 'WARN', '/tmp', 1,
                                      'Message', None, None)
        expected = logrecord
        self.assertEqual(self.logger.format(logrecord), expected.getMessage())

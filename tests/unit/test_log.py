...
class DomainTestCase(test.BaseTestCase):
    ...
    def test_domain_in_log_msg(self):
        ctxt = _fake_context()
        ctxt.domain_id = 'mydomain'
        ctxt.project_domain_id = 'myprojectdomain'
        ctxt.user_domain_id = 'myuserdomain'
        self._validate_keys(ctxt, ('[%s]: %s %s %s' %
                                   (ctxt.request_id, ctxt.domain_id,
                                    ctxt.project_domain_id,
                                    ctxt.user_domain_id)))

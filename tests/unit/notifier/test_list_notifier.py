...
class NotifierListTestCase(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        list_notifier_log = logging.getLogger('openstack.common.notifier.'
                                              'list_notifier')
    ...
    def test_send_notifications_successfully(self):
        self.config(notification_driver='openstack.common.'
                    'notifier.list_notifier', list_notifier_drivers=[
    ...
    def test_adding_and_removing_notifier_object(self):
        ...
        self.config(notification_driver='openstack.common.'
                    ...
                    list_notifier_drivers=['openstack.common.notifier.'
                                           'no_op_notifier'])

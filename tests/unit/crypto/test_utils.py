...
class CryptoUtilsTestCase(test_utils.BaseTestCase):
    ...
    def _test_HKDF(self, ikm, prk, okm, length,
        ...
        hkdf = crypto.utils.HKDF(hashtype=hashtype)
    ...
    def test_HKDF_8(self):
        ...
        except crypto.utils.HKDFOutputLengthTooLong:
            pass

    def test_SymmetricCrypto_encrypt_string(self):
        msg = 'Plain Text'

        skc = crypto.utils.SymmetricCrypto()
        key = skc.new_key(16)
    ...
    def test_SymmetricCrypto_encrypt_blocks(self):
        ...
        skc = crypto.utils.SymmetricCrypto(enctype=et)
        key = skc.new_key(16)

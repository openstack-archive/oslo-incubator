...
class CryptoUtilsTestCase(test_utils.BaseTestCase):
    ...
    def test_SymmetricCrypto_encrypt_block(self):
        cb = 16
        et = 'AES'
        ...
        cipher = skc.encrypt(key, msg, b64encode=False)
        # iv plus padding will cause the cipher to be 2 blocks size bigger
        self.assertEqual(cb * 3, len(cipher))

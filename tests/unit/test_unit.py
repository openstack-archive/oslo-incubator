...
class UnitTest(test.BaseTestCase):
    def test_byteunit(self):
        ...
        self.assertEqual(unit.byte.Ei, 1024 ** 6)
        self.assertEqual(unit.byte.Zi, 1024 ** 7)
        self.assertEqual(unit.byte.Yi, 1024 ** 8)
    ...
    def test_byteunit_readonly(self):
        ...
        self.assertRaises(AttributeError, set_readonly_Ei)
        self.assertRaises(AttributeError, set_readonly_Zi)
        self.assertRaises(AttributeError, set_readonly_Yi)

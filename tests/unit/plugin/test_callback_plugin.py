...
class TestCBP(callbackplugin.CallbackPlugin):
    ...
    def __init__(self):
        super(TestCBP, self).__init__()
        self.callback1count = 0
        self.callback2count = 0
        self.callback3count = 0

        self.add_callback(self.callback1, 'type1', None)
        self.add_callback(self.callback2, 'type1', None)
        self.add_callback(self.callback3, 'type2', 'magic user data string')

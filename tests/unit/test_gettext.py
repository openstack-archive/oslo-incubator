...
class MessageTestCase(test.BaseTestCase):
    ...
    def test_translate_returns_unicode(self):
        ...
        self.assertEqual(type(message.translate()), unicode)
    ...
    def test_mod_with_named_parameters(self):
        ...
        self.assertEqual(result.translate(), msgid % params)
    ...
    def test_message_copyable(self):
        ...
        self.assertIsNot(message, copied)

        for attribute, value in message.__dict__.iteritems():
            self.assertEqual(getattr(copied, attribute), value)

        self.assertEqual(message.translate(), copied.translate())

    def test_unicode_prohibited(self):
        message = self.message('Some message')
        self.assertRaises(TypeError, message.__unicode__)

    def test_str_prohibited(self):
        message = self.message('Some message')
        self.assertRaises(TypeError, message.__str__)

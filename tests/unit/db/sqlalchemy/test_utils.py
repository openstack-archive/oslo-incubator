...
class UtilsOpportunisticTestCase(base.MySQLOpportunisticTestCase):
    def setUp(self):
        super(UtilsOpportunisticTestCase, self).setUp()
    ...
    def test_column_exists(self):
        for col in ['a', 'b', 'c']:
            self.assertTrue(utils.column_exists(self.engine, 'test_table',
                                                col))
        self.assertTrue(utils.column_not_exists(self.engine, 'test_table',
                                                'fake_column'))

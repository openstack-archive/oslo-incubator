...
class MySQLCIFixture(CIFixture):
    DRIVER = 'mysql'


class PostgreSQLCIFixture(CIFixture):
    DRIVER = 'postgres'


class MySQLCITestCase(DbTestCase):
    FIXTURE = MySQLCIFixture


class PostgreSQLCITestCase(DbTestCase):
    FIXTURE = PostgreSQLCIFixture

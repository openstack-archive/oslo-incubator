...
class JSONUtilsTestCase(test_base.BaseTestCase):
    ...
    def _test_loads_unicode(self):
        self.assertEqual(type(jsonutils.loads('"foo"')), six.text_type)
        self.assertEqual(type(jsonutils.loads(u'"foo"')), six.text_type)

        i18n_str = '"\xd1\x82\xd0\xb5\xd1\x81\xd1\x82"'
        self.assertEqual(type(jsonutils.loads(i18n_str)), six.text_type)

        i18n_str_unicode = strutils.safe_decode(i18n_str)
        self.assertEqual(type(jsonutils.loads(i18n_str_unicode)),
                         six.text_type)

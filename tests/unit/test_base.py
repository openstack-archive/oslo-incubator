...
class TestModelsObjectComparatorMixin(test.BaseTestCase,
    ...
    def test_equal_object_and_dict(self):
        self.assertEqualObjects(self.obj1, self.dict1)

    def test_not_equal_object_and_dict(self):
        self.assertRaises(matchers.MismatchError,
                          self.assertEqualObjects,
                          self.obj2, self.dict1)

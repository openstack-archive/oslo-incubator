...
from openstack.common import base64utils
...
class TestValid(test.BaseTestCase):
...
class TestBase64Padding(test.BaseTestCase):
...
class TestTextWrap(test.BaseTestCase):

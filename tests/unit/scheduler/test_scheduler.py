...
class SchedulerManagerTestCase(utils.BaseTestCase):
    ...
    driver_cls_name = 'tests.unit.scheduler.fake_driver.FakeScheduler'

    def setUp(self):
        super(SchedulerManagerTestCase, self).setUp()
        self.config(project_name='fake_project', group="manager")
        self.config(db_driver='tests.unit.scheduler')
        self.config(scheduler_driver=self.driver_cls_name, group='scheduler')
        self.manager = self.manager_cls(host='fake_host')

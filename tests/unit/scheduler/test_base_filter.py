...
class TestBaseFilterHandler(test.BaseTestCase):
    ...
    def _get_filtered_objects(self, filter_classes):
    ...
    def _fake_run_filter_for_index(self, index):
        return False

    @mock.patch.object(FakeFilter1, 'run_filter_for_index',
                       _fake_run_filter_for_index)
    def test_get_filtered_objects_with_filter_run_once(self):
        filter_objs_expected = [1, 2, 3, 4]
        filter_classes = [FakeFilter1]

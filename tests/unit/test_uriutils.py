...
class UriUtilsTest(test_base.BaseTestCase):
    ...
    def test_is_valid_uri_with_port(self):
        ...
        self.assertTrue(uriutils.is_valid_uri('http://localhost:65535'))
    ...
    def test_is_valid_uri_with_invalid_host(self):
        ...
        self.assertFalse(uriutils.is_valid_uri('http://localhost:80:80:80'))

    def test_is_valid_uri_with_invalid_port(self):
        self.assertFalse(uriutils.is_valid_uri('http://localhost:65536'))

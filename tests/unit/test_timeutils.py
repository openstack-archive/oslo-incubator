...
class TestIso8601Time(utils.BaseTestCase):
    ...
    def test_zulu(self):
        ...
        self._do_test(str, 2012, 0o2, 14, 20, 53, 7, 0, 0)

    def test_zulu_micros(self):
        str = '2012-02-14T20:53:07.123Z'
        self._do_test(str, 2012, 0o2, 14, 20, 53, 7, 123000, 0)

    def test_offset_east(self):
        str = '2012-02-14T20:53:07+04:30'
        offset = 4.5 * 60 * 60
        self._do_test(str, 2012, 0o2, 14, 20, 53, 7, 0, offset)

    def test_offset_east_micros(self):
        str = '2012-02-14T20:53:07.42+04:30'
        offset = 4.5 * 60 * 60
        self._do_test(str, 2012, 0o2, 14, 20, 53, 7, 420000, offset)
    ...
    def test_offset_west_micros(self):
        ...
        offset = -5.5 * 60 * 60
        self._do_test(str, 2012, 0o2, 14, 20, 53, 7, 654321, offset)
    ...
    def test_normalize_naive(self):
        dt = datetime.datetime(2011, 2, 14, 20, 53, 0o7)
        dtn = datetime.datetime(2011, 2, 14, 19, 53, 0o7)

...
class TestModelReportType(test.DbTestCase):
...
class TestGenericXMLView(test.DbTestCase):
    def setUp(self):
...
class TestGenericJSONViews(test.DbTestCase):
    def setUp(self):
...
class TestGenericTextViews(test.DbTestCase):
    def setUp(self):
...
class TestJinjaView(test.DbTestCase):

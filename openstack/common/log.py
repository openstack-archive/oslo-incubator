...
log_opts = [
    ...
    cfg.StrOpt('log_additional_locale',
               ...
               'used. The additional log will be created in the same '
               'directory as the main log, inside a directory named after the '
               'locale. The locale is usually specified as "ll_CC", '
               'where "ll" is the language code, "CC" is the country code. '
               'For example: en_US, en_GB, and de_DE.'
               'For more details on how to specify the locale name refer to '

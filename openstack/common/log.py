...
log_opts = [
    ...
    cfg.StrOpt('log_additional_locale',
               ...
               'language is installed. This option is only enabled if the '
               '\'log-file\' option is used, and the additional log will be '
               'created in the same directory as the main log, inside a '
               'directory named after the locale.'),
]
...
def _setup_logging_from_conf():
    ...
    if logpath:
        ...
        _setup_secondary_log_from_conf(logpath, log_root)
...
def _setup_secondary_log_from_conf(primary_logpath, log_root):
    ...
    all_languages = gettextutils.get_available_languages('oslo')
    if extra_locale not in all_languages:
        ...
        msg = (_('Locale \'%(locale)s\' is not available. '
                 ...
                 'remove the \'log_additional_locale\' property.') %

...
def safe_unicode(obj):
    ...
    try:
        ...
        pass
    # Try various encodings (in strict-mode) to see if we can get one that
    # successfully decodes into unicode.
    for (encoding, errors) in ((locale.getpreferredencoding(), 'strict'),
                               ('utf-8', 'strict'), ("latin-1", "strict")):
        try:

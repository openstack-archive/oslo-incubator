...
class WalkVersionsMixin(object):
    ...
    def _walk_versions(self, snake_walk=False, downgrade=True):
        """Check is migration upgrading and downgrading successfully
        ...
        :snake_walk: Boolean. Force double check if True.
        :downgrade: Boolean. Check downgrade behavior if True.
        """

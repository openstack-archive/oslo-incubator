...
def add_index(migrate_engine, table, index_name, idx_columns):
    if not _index_exists(migrate_engine, table.name, index_name):
        index = Index(
...
def drop_index(migrate_engine, table, index_name, idx_columns):
...
def change_index_columns(migrate_engine, table, index_name,
                         new_columns, old_columns):
    drop_index(migrate_engine, table, index_name, old_columns)
    add_index(migrate_engine, table, index_name, new_columns)

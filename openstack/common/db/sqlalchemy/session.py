...
def _assert_matching_drivers():
    ...
    if CONF.slave_connection == '':
        return

    c_dict = sqlalchemy.engine.url.make_url(CONF.connection)
    slave_c_dict = sqlalchemy.engine.url.make_url(CONF.slave_connection)

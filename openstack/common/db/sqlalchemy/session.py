...
database_opts = [
    ...
    cfg.StrOpt('mysql_sql_mode',
               ...
               help='The SQL mode to be used for MySQL sessions. '
                    'Default is TRADITIONAL, overriding any server-side SQL '
                    'mode setting. To use whatever SQL mode is set by the '
                    'server configuration, set this to the empty string.'),

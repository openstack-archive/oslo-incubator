...
#
# sqlite since 3.7.16:
# 1 column - (IntegrityError) UNIQUE constraint failed: t1.k1
#
# N columns - (IntegrityError) UNIQUE constraint failed: t1.k1, t1.k2
#
# postgres:
...
def _raise_if_duplicate_entry_error(integrity_error, engine_name):
    ...
    if engine_name == "sqlite":
        columns = map(lambda c: c.split('.')[-1], columns.strip().split(", "))
    else:

...
http_notify_opts = [
    ...
    cfg.ListOpt('callback_notification_events',
                default=['compute.instance.create.end',
                         'compute.instance.delete.end',
                         'volume.create.end',
                         'volume.delete.end',
                         'volume.snapshot.create.end',
                         'volume.snapshot.delete.end'],
                help='list of notification events')
    ]
...
def notify(context, message):
    ...
    if CONF.callback_notification_events and \
            event_type in CONF.callback_notification_events:

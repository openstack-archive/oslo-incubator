...
def add_notification_to_method(cls, method):
    ...
    For example, this will cause any call to change_instance_metadata to send
    a notificaton of type
    'nova.compute.manager.ComputeManager.change_instance_metadata':

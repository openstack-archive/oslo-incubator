...
class BaseCache(object):
    ...
    @classmethod
    def register_opts(cls, conf, group=None):
        """Registers backend's specific configs

        NOTE: Each implementation has to make sure
        the configuration parameters haven't been
        registered already.

        :params conf: The configuration instance
        :params group: The configuration group to use
        """

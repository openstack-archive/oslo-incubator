...
def get_cache(conf):
    ...
    # exist before registering them. The code below
    # should be safe.
    ...
    kwargs = dict(cache_namespace=conf.oslo_cache.key_namespace)

    backend = conf.oslo_cache.default_backend

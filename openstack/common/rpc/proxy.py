...
class RpcProxy(object):
    ...
    If there is a timeout exception, it'll add information to the message that
    should proove useful in logging later.
    """
    ...
    def _get_new_timeout_msg(orig_exc, topic, rpc_method_name):
        """
        Returns a new, better message for rpc timeouts
        ...
        detail_dict = {'method': rpc_method_name,
                       ...
                       'exc': str(orig_exc)}
        return (_(
            'Original Exception Message: "%(exc)s" - '

...
matchmaker_opts = [
    ...
    cfg.StrOpt('ringfile',
               depreciated_name='matchmaker_ringfile',
               depreciated_group='DEFAULT',
...
class MatchMakerRing(mm.MatchMakerBase):
    ...
    def __init__(self, ring=None):
        ...
        self.add_binding(mm.FanoutBinding(), mm.FanoutRingExchange(ring))
        self.add_binding(mm.DirectBinding(), mm.DirectExchange())
        self.add_binding(mm.TopicBinding(), mm.RoundRobinRingExchange(ring))

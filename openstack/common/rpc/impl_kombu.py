    ...
    def __init__(self, conf, server_params=None):
        ...
        for adr in self.conf.rabbit_hosts:
            ...
            if self.conf.fake_rabbit:
                ...
                # Must use the pyamqp transport to take advantage of
                # kombu 2.3's consumer cancellation notifications that
                # happen when a consumer is consuming a replica of an
                # H/A queue and the queue's master dies.

...
kombu_opts = [
    ...
    cfg.StrOpt('kombu_ssl_keyfile',
               default='',
               help='If SSL is enabled, the SSL key file to use.'),
    cfg.StrOpt('kombu_ssl_certfile',
               default='',
               help='If SSL is enabled, the SSL cert file to use.'),
    cfg.StrOpt('kombu_ssl_ca_certs',
               default='',
               help=('If SSL is enabled, the SSL certification authority '
                     'file to use.')),
    ...
    cfg.BoolOpt('rabbit_use_ssl',
                default=False,
                help='Enables or disables SSL connection for RabbitMQ.'),
    ...
    cfg.IntOpt('rabbit_retry_interval',
               default=1,
               help='The retry frequency for RabbitMQ connections.'),
    cfg.IntOpt('rabbit_retry_backoff',
               default=2,
               help='How long to back off between connection retries '
                    'to RabbitMQ.'),

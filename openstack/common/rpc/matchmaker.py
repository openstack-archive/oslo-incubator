...
class MatchMakerRing(object):
    def __init__(self, *args):
        LOG.warn(_("Depreciated. Import rpc/matchmaker_ring instead."))
        driver = importutils.import_class(
            'openstack.common.rpc.matchmaker_ring.MatchMakerRing')
        self.ring = driver(*args)

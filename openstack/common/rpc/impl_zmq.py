...
zmq_opts = [
    ...
    cfg.IntOpt('rpc_zmq_contexts', default=1,
               help='Number of ZeroMQ contexts. Default is 1.'),
    ...
    cfg.StrOpt('rpc_zmq_host', default=socket.gethostname(),
               help='Name of this node. Valid values are a host name, FQDN, '
                    'and IP address. If you run nova, this value must match '
                    'the host option value.')

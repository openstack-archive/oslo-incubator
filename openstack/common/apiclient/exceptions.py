...
class MissingArgs(ClientException):
    ...
    def __init__(self, missing):
        ...
        if len(self.missing) == 1:
            msg = "An argument is missing"
        else:
            msg = ("%(num)d arguments are missing" %
...
class AuthSystemNotFound(ClientException):
    """User has specified a AuthSystem but not installed."""
...
class HttpError(ClientException):
    ...
    def __init__(self, message=None, details=None, request_id=None,

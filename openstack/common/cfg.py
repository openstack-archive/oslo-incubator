...
class ParseError(iniparser.ParseError):
    def __init__(self, msg, line, filename, lineno):
        super(ParseError, self).__init__(msg, line)
...
class ConfigParser(iniparser.BaseParser):
    def __init__(self, filename, sections):
        ...
        self.new_section('DEFAULT')

    def parse(self):
        return super(ConfigParser, self).parse(self.file)
    ...
    def parse_exc(self, msg, line):
        return ParseError(msg, line, self.filename, self.lineno)
...
class ConfigOpts(collections.Mapping):
    ...
    def _parse_config_files(self, config_files):
        ...
        except iniparser.ParseError as cpe:
            raise ConfigFileParseError(cpe.filename, str(cpe))

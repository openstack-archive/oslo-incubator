...
help_for_enable_backdoor = 'Acceptable settings include ' + \
    'random, port_hint:<port> and unix_sock, where random results the ' + \
    'listening on a randomn tcp port number, port_hint results ' + \
    'in listening on the closest unused socket higher than the ' + \
    'specified port and unix_sock results in listening on a unix ' + \
    'domain socket named by openstack_<process ID>'

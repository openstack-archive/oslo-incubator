...
# NOTE: In order to use default body serial/deserializers in the project
# wsgi_body_serializers module should be added to the project's
# openstack-common.conf (so that update.py copy it along with wsgi module)
serializer_opts = [
    cfg.StrOpt('json_serializer',
               default='openstack.common.wsgi_body_serializers.'
                       'JSONDictSerializer',
               help='JSON body serializer to be used in Response '
                    '(class path)'),
    cfg.StrOpt('xml_serializer',
               default='openstack.common.wsgi_body_serializers.'
                       'XMLDictSerializer',
               help='XML body serializer to be used in Response '
                    '(class path)'),
    cfg.StrOpt('json_deserializer',
               default='openstack.common.wsgi_body_serializers.'
                       'JSONDeserializer',
               help='JSON body deserializer to be used in Request '
                    '(class path)'),
    cfg.StrOpt('xml_deserializer',
               default='openstack.common.wsgi_body_serializers.'
                       'XMLDeserializer',
               help='XML body deserializer to be used in Request '
                    '(class path)'),
]

CONF = cfg.CONF
CONF.register_opts(socket_opts)
CONF.register_opts(serializer_opts)
...
class ResponseSerializer(object):
    ...
    def __init__(self, body_serializers=None, headers_serializer=None):
        self.body_serializers = {
            'application/xml': importutils.import_object(CONF.xml_serializer),
            'application/json': importutils.import_object(
                CONF.json_serializer),
        }
...
class RequestDeserializer(object):
    ...
    def __init__(self, body_deserializers=None, headers_deserializer=None,
        ...
        self.body_deserializers = {
            'application/xml': importutils.import_object(
                CONF.xml_deserializer),
            'application/json': importutils.import_object(
                CONF.json_deserializer),
        }

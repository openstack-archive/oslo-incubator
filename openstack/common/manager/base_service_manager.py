...
class BaseManager(db_base.Base, periodic_task.PeriodicTasks):
    ...
    def init_host(self):
        ...
        """
        raise NotImplementedError(_("Must implement host initialization."))
    ...
    def pre_start_hook(self, **kwargs):
        ...
        """
        raise NotImplementedError(_("Must implement pre-start work."))
    ...
    def post_start_hook(self):
        ...
        """
        raise NotImplementedError(_("Must implement post-start work."))

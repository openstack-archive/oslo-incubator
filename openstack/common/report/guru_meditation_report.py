...
This can be used in the Opensack command definition files.
...
import openstack.common.report.generators.openstack_specific as osg
from openstack.common.report.report import TextReport
...
class GuruMeditation(object):
    ...
    def handle_signal(cls, version, *args):
        ...
        dumping the Guru Meditation Report to stderr.  This method is desiged
    ...
    def _readd_sections(self):
        ...
        self.add_section('Package',
                         osg.PackageReportGenerator(self.version_obj))
...
# GuruMeditation must come first to get the correct
# MRO
class TextGuruMeditation(GuruMeditation, TextReport):

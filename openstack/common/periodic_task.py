...
class PeriodicTasks(object):
    ...
    def run_periodic_tasks(self, *args, **kwargs):
        ...
        for task_name, task in self._periodic_tasks:
            ...
            if ticks_to_skip > 0:
                LOG.debug(_("Skipping {full_task_name}, {ticks_to_skip}"
                            " ticks left until next run").format(
            ...
            LOG.debug(_("Running periodic task {full_task_name}").format(
                      full_task_name=full_task_name))
            ...
            try:
                ...
                if raise_on_error:
                    raise
                LOG.exception(_("Error during (full_task_name}: {e}").format(
                              e=e, full_task_name=full_task_name))

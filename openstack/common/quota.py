...
class DbQuotaDriver(object):
    ...
    def get_by_project(self, context, project_id, resource):
        ...
        return self.db.quota_get(context, project_id, resource)

    def get_by_class(self, context, quota_class, resource):
        """Get a specific quota by quota class."""

        return self.db.quota_class_get(context, quota_class, resource)
    ...
    def get_project_quotas(self, context, resources, project_id,
                           ...
                           usages=True):
        """Given a list of resources, get quotas for the given project.
        ...
        quotas = {}
        project_quotas = self.db.quota_get_all_by_project(context,
                                                          project_id)
        if usages:
            project_usages = self.db.\
    ...
    def reserve(self, context, resources, deltas, expire=None,
        ...
        return self.db.quota_reserve(context, resources, quotas, deltas,
                                     expire, CONF.until_refresh,
                                     CONF.max_age, project_id=project_id)
    ...
    def destroy_all_by_project(self, context, project_id):
        """Destroy all quotas, usages, and reservations for project.
...
class NoopQuotaDriver(object):
    """Driver that turns quotas calls into no-ops.

    This driver pretends that quotas for all resources are unlimited. This
    can be used if you do not wish to have any quota checking.  For instance,
    with nova compute cells, the parent cell should do quota checking, but
    the child cell should not.
    """
    ...
    def get_class_quotas(self, context, resources, quota_class,
                         defaults=True):
        """Given a list of resources, retrieve quotas for given quota class.
    ...
    def get_project_quotas(self, context, resources, project_id,
                           quota_class=None, defaults=True,
                           usages=True):
        """Given a list of resources, get quotas for project.
    ...
    def usage_reset(self, context, resources):
        ...
        This will force that user's usage records to be
        refreshed the next time a reservation is made.
...
class ReservableResource(BaseResource):
    ...
    def __init__(self, name, flag=None):
        ...
        :param name: The name of the resource, i.e., "instances".
                     This name is also key for QUOTA_SYNC_FUNCTIONS.
        :param flag: The name of the flag or configuration option
                     which specifies the default value of the quota
                     for this resource.
        """
...
class QuotaEngine(object):
    ...
    def usage_reset(self, context, resources):
        """Reset the usage records for a particular user on a resources list.

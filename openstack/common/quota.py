...
from openstack.common.gettextutils import _, _LD, _LE  # noqa
    ...
    def get_defaults(self, context, resources):
        ...
        for resource in resources.values():
            if resource.name not in default_quotas:
                LOG.deprecated(
                    _LD("Default quota for resource: %(res)s is set "
...
class QuotaEngine(object):
    ...
    def reserve(self, context, expire=None, project_id=None, user_id=None,
        ...
        LOG.debug(_LD("Created reservations %s"), reservations)
    ...
    def commit(self, context, reservations, project_id=None, user_id=None):
        ...
        try:
            ...
            LOG.exception(_LD("Failed to commit reservations %s"),
                          reservations)
            return
        LOG.debug(_LD("Committed reservations %s"), reservations)
    ...
    def rollback(self, context, reservations, project_id=None, user_id=None):
        ...
        try:
            ...
            # mechanisms will resolve the issue.  The exception is
            # logged, however, because this is less than optimal.
            LOG.exception(_LD("Failed to roll back reservations %s"),
                          reservations)
            return
        LOG.debug(_LD("Rolled back reservations %s"), reservations)

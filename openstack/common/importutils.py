...
class LazyPluggable(object):
    ...
    Here is example of how this class used in Nova.
    ...
    def __init__(self, conf, pivot, config_group=None, **backends):
        ...
        :param backends: supported backends, which must be a mapping where
            keys are the names of supported backends and

...
import oslo.messaging.openstack.common.gettextutils
    ...
    def _get_backend(self):
        if not self._backend:
            ...
            if backend_name not in self._backends:
                msg = oslo.messaging.openstack.common.gettextutils._(
                    'Invalid backend: %s') % backend_name

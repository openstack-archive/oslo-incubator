...
class BaseManager(periodic_task.PeriodicTasks):
    ...
    def __init__(self, conf, host=None, db_driver=None,
    ...
    def get_apis(self, backdoor_port=None, additional_apis=None):
        return [self]
    ...
    def service_config(self, context):
        ...
        for key in self.conf:
            config[key] = self.conf.get(key, None)
        return config
...
class BaseSchedulerDependentManager(BaseManager):
    ...
    def __init__(self, conf, host=None, db_driver=None,
        ...
        self.service_name = service_name
        self.scheduler_rpcapi = scheduler_rpcapi.SchedulerAPI(conf)
        super(BaseSchedulerDependentManager, self).__init__(conf, host,
                db_driver, service_name, component_name)
    ...
    def publish_service_capabilities(self, context):
        self._publish_service_capabilities(self, context)

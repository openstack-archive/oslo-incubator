...
CONF = cfg.CONF
CONF.register_opt(scheduler_driver_opt, group='scheduler')
...
class BaseSchedulerManager(base_service_manager.BaseManager):
    ...
    def __init__(self, scheduler_driver=None, *args, **kwargs):
        super(BaseSchedulerManager, self).__init__(service_name='scheduler',
                                                   *args, **kwargs)
        if not CONF.scheduler.scheduler_driver:
            raise exception.Invalid(_("`scheduler_driver` option for service "

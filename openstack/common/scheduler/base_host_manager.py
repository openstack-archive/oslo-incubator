...
CONF = cfg.CONF
CONF.register_opts(host_manager_opts, group='scheduler')
...
class BaseHostManager(object):
    ...
    def __init__(self, *args, **kwargs):
        self.service_states = {}
        self.host_state_map = {}
        self.filter_handler = filters.HostFilterHandler(CONF.scheduler.
                                                        filter_handler)
        self.filter_classes = self.filter_handler.get_all_classes()
        self.weight_handler = weights.HostWeightHandler(CONF.scheduler.
                                                        weight_handler)

...
# NOTE(ldbragst): Only set weak_store and store to ThreadingWeakLocal if
# not previously defined from instantiating EventletWeakLocal class.
if not weak_store:
    weak_store = ThreadingWeakLocal()

if not store:
    store = ThreadingWeakLocal()

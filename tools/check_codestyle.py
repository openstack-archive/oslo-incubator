...
def _check_import_style(path, line, num):
    """
    Check import style , should use like from openstack.common.* import,
    ...
    if IMPORT_RE.match(line):
        return_value = 1
        print("ERROR: Should import module like 'from openstack.common.* import' : "
              "in file %s line %d" % (path, num + 1))
